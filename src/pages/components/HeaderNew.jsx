...
export default function HeaderNew(props) {
  ...
  const navLinks = [
    { tilte: "Exchange", page: "/exchange/btc-inr" },
    { tilte: "P2P", page: "/p2p/usdt-inr" },
    { tilte: "Staking", page: "/btexstaking" },
  ];
  ...
  return (
    <>
      ...
      <header>
        <nav
          className={`ex-navbar
           navbar navbar-expand-lg navbar-light navbar-bg py-0`}
        >
          ...
          <button
            ...
            id=""
            style={{ zIndex: "1", border: "none", outline: "none" }}
          >
            <GiHamburgerMenu
          ...
          <div id="ca-navbar" className="collapse navbar-collapse manu_header">
              ...
              {navLinks.length > 0 &&
                navLinks.map((nav, index) => (
                  <li className="nav-item">
                    <Link className={index==0 ? "nav-link ex-nav-link nav-active" : "nav-link ex-nav-link"} to={nav.page}>
                      {nav.tilte}
                    </Link>
                  </li>
                ))}
            ...
            <div className="sing-up-button  d-lg-none ">
              ...
              {location.pathname !== "/create" && !isLoggedIn ? (
                <Link to="/create">
                  {" "}
                  <b className="text-success"> Register</b>
                </Link>
              ) : null}
              {isLoggedIn ? (
                <>
          ...
          >
            <a
              ...
              className="text-light d-none d-lg-block float-left mr-3"
            >
              <svg
            ...
            <a
              href="/notification"
              className="text-light d-none d-lg-block float-left"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <div className=" d-none d-lg-block ">
            ...
            !isLoggedIn ? (
              <Link to="/login">
                <b className="btn btn-success mx-2 px-4"> Login </b>
              </Link>
            ) : null}
            ...
            !isLoggedIn ? (
              <Link className="btn-theme-color" to="/create">
                <b className="text-white btn btn-success mx-2 px-4">
                  {" "}
                  Register
                </b>
              </Link>
