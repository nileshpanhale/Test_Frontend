    ...
    <header>
      ...
      >
        ...
        <div id="ca-navbar" className="collapse navbar-collapse manu_header">
          <ul id="nav" className="navbar-nav">
            ...
            <li className="nav-item" style={{ borderTop: "0px!important"  }} >
              ...
              <Link className="nav-link "    to="/p2p/usdt-inr"  >
                P2P
              </Link>
            </li>
            <li className="nav-item" style={{ borderTop: "0px!important"  }}>
              <Link className="nav-link " to="/btexstaking">
                Staking
              </Link>
            </li>
            {/* <li className="nav-item" style={{ borderTop: "0px!important" }}>
          ...
          <div className="sing-up-button  d-lg-none " >
            {location.pathname !== "/login" && !isLoggedIn ? (
              <Link to="/login"> <b className="text-success "> Login </b> </Link>
            ) : null}
            {location.pathname !== "/create" && !isLoggedIn ? (
              <Link to="/create"> <b className="text-success"> Register</b></Link>
            ) : null}
            {isLoggedIn ? (
              <>
        ...
        <div className=" d-none d-lg-block " >
          ...
          !isLoggedIn ? (
            <Link to="/login"><b className="btn btn-success mx-2 px-4"> Login </b></Link>
          ) : null}
          ...
          !isLoggedIn ? (
            <Link className="btn-theme-color" to="/create">
              <b className="text-white btn btn-success mx-2 px-4"> Register</b>
            </Link>
          ) : null}
          {isLoggedIn ? (
            <>
