  ...
  <div class="row">
    ...
    <div className="signupContainer" style={{}}>
        <div
          ...
          // style={{ backgroundImage:"./image/BG.png"}}
          ...
          <div className="row d-flex justify-content-center">
            <div className="col col-md-7 col-sm-12 " >
              ...
              >
                ...
                <div className={`signupform-control`}>
                  <label htmlFor="user_email" className=" text-success"  >
                    EMAIL
                  </label>
                  <input
                    type="email"
                ...
                <div className="signupform-control ">
                  <label htmlFor="user_password" className=" text-success"  >
                    PASSWORD
                  </label>
                  <Link className="resend_btn" to="/forget">
                    Forgot Password
                  </Link>
                ...
                <Link
                  className="signupform-login text-success"
                  to="/create"
                >
                <b className="text-dark h6  ">If you don't have any account yet | </b> <b>  REGISTER </b>
                </Link>
              </form>
            </div>
          </div>
    ...
    <div className="col-sm  img_hider" style={{backgroundImage:"url(./image/BG_5.png)",height:"100vh" , backgroundSize:"cover"}} >
